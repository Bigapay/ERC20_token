...
contract BigaPay is Context, IERC20, Ownable {
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 6000000, "Swap Threshold Amount cannot be less than 6 Million");
